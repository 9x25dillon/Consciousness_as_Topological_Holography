...
class UnifiedCoherenceSystem:
    ...
    def _generate_unified_response(self, guard_result: Dict, audit_result: AuditState,
        ...
        abs_meta = guard_result.get('meta', {}).get('absorption')
        original_message = abs_meta.get('original_signal', 'N/A') if abs_meta else sample.context.get('original_message', 'N/A')
